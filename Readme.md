...
Durante el desarrollo se realizaron diferentes pruebas con el carácter **U**, el carácter **^**, la transmisión repetida del carácter y el mensaje:
...
Para una tasa de transmisión de 9600 baudios, el tiempo teórico de bit es:

[
T_b=\frac{1}{9600}=104.1667\ \mu s
]

Experimentalmente se obtuvo aproximadamente **104 µs**, con un error del **0.16 %**.

Para una trama de 10 bits:

[
T_{trama}=10T_b=1.041667\ ms
]
...
* **Código:** programas utilizados en la Raspberry Pi Pico 2W.
